...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("debería retornar estado http 200 cuando los datos ingresados sean válidos")
    @WithMockUser
    void agendarEscenario2() throws Exception {
        ...
        var especialidad = Especialidad.OCULISTA;
        var datos = new DatosDetalleConsulta(null,4L,2L,fecha);
        ...
        var response = mvc.perform(post("/consultas")
                        ...
                        .content(agendarConsultaJacksonTester.write(new DatosAgendarConsulta(4L, 2L, fecha,especialidad)).getJson())
    ...
    //Desafío probar el 404 pasando un id incorrecto
}